...
app.set('views','./05-Nodejs-Express-Server-EJS-Template-Engine-Part-4/views');
// app.set('views', path.join(__dirname, '/05-Nodejs-Express-Server-EJS-Template-Engine-Part-4/views');'));
